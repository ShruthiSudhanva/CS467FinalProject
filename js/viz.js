var custom_bubble_chart = (function(d3, CustomTooltip) {
  ...
  function custom_chart(data) {
    ...
    radius_scale = d3.scale.pow().exponent(0.5).domain([0, max_price]).range([2, 70]);
  ...
  function display_types() {
      var types_x = {"ONLONL": width/4, "ONLSTR": width / 2, "STRONL": 3* width/4, "STRSTR": width};
  ...
  function display_categories() {
      var categories_x = {"F": width/5, "G": 2*width / 5, "C": 3* width/5, "S": 4*width/5, "E":width};
  ...
  function display_users() {
      var users_x = {"Shruthi": width/4, "Shugo": width / 2, "Lavanya": 3* width/4, "Rimi": width};
